...
const ChartProComponent: Component<ChartProComponentProps> = (props) => {
	...
	onMount(() => {
		...
		if (widget) {
			...
			if (watermarkContainer) {
				...
				watermark.className = 'ucharts-pro-watermark';
			...
			priceUnitDom.className = 'ucharts-pro-price-unit';
	...
	return (
		<>
			<i class="icon-close ucharts-pro-load-icon" />
			...
			<div class="ucharts-pro-content">
				...
				<div ref={widgetRef} class="ucharts-pro-widget" data-drawing-bar-visible={drawingBarVisible()} />
			</div>
		</>
	);
};
